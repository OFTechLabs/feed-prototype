...
export class FeedComponent implements OnInit {
    ...
    public queryOratio(): void {
        this.model$.pipe(take(1)).subscribe((model: AppModel) => {
            ...
            result.then(response => {
                ...
                if (response instanceof UnderstoodResponse) {
                    ...
                    model.assistantResponse = this.i18nService.translate(text, response.params);
                } else {
                    this.store.dispatch(new UpdateFeedAssistanceResponse(this.i18nService.translate(text)));
                    model.assistantResponse = this.i18nService.translate(text);
                }
